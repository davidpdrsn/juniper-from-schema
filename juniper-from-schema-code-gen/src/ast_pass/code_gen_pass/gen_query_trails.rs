...
impl<'pass, 'doc> QueryTrailCodeGenPass<'pass, 'doc> {
    ...
    fn gen_field_walk_method(
        ...
        match ty {
            TypeKind::Scalar => {
                ...
                self.gen_args_query_trail(
                    field,
                    &name,
                    obj,
                    &mut method_signature,
                    &mut method_implementation,
                    &mut arguments_implementation,
                );
    ...
    fn gen_args_query_trail(
        ...
        name: &Ident,
        obj: &InternalQueryTrailNode,
        method_signature: &mut TokenStream,
        method_implementation: &mut TokenStream,
        arguments_implementation: &mut TokenStream,
    ) {
